...
class RegionProposalNetwork(nn.Module):
    ...
    def __init__(self, num_features_out, anchor_ratios, anchor_sizes,
                 pre_nms_top_n, post_nms_top_n, anchor_smooth_l1_loss_beta):
        super().__init__()
    ...
    def generate_anchors(self, image_width, image_height, num_x_anchors, num_y_anchors):
